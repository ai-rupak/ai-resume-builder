...
export const Hero = () => {
  ...
  return (
    <section className="relative pt-32 pb-16 bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50 overflow-hidden min-h-screen">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            {/* Description */}
            <p className=" text-gray-600 mb-8 max-w-2xl leading-relaxed text-base sm:text-lg md:text-xl mx-auto px-2">
              Create professional, ATS-friendly resumes in minutes using
              AI-powered suggestions. Stand out from the crowd with personalized
              content and stunning templates.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <Link to={"/auth/sign-in"} className="w-full sm:w-auto">
                <Button
                  // onClick={}
                  className="relative group bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white text-lg px-8 py-6 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
                >
            ...
            <div className="mt-8 flex items-center justify-center lg:justify-start space-x-1">
              <div className="flex -space-x-2">
                {[1, 2, 3, 4, 5].map((i) => (
                  <div
                    key={i}
                    className="w-8 h-8 bg-gradient-to-br from-purple-400 to-blue-400 rounded-full border-2 border-white flex items-center justify-center text-white text-xs font-semibold"
                  >
                    {i}
                  </div>
                ))}
          ...
          >
            <div className="relative z-10 group max-w-md mx-auto lg:max-w-lg">
              {/* <div className="relative overflow-hidden rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-500 transform hover:-translate-y-2"> */}
                <img
                  ...
                  className="w-full h-auto transform group-hover:scale-105 transition-transform duration-700 object-contain"
                />
